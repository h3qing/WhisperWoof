    ...
    >
      ...
      <div
        className={cn(
          ...
          isSuccess ? "bg-success/60" : "bg-mando/60"
        )}
        style={{
          ...
          boxShadow: isSuccess
            ...
            : "0 0 24px 8px color-mix(in oklch, var(--color-mando) 15%, transparent)",
          ...(isSuccess ? { top: "50%" } : {}),
        }}
      />
      ...
      >
        {isSuccess ? (
          ...
          <>
            <span className="text-xs font-medium text-mando-deep tracking-tight">{actionName}</span>
            <div className="w-32 h-0.5 bg-mando/15 rounded-full overflow-hidden">
              <div
                className="h-full w-1/3 bg-mando rounded-full"
