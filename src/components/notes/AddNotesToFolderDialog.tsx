        ...
        <div className="px-4 pr-12 pt-4 pb-2">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-8 rounded-md bg-foreground/[0.03] border border-foreground/8 pl-8 pr-3 text-xs text-foreground placeholder:text-muted-foreground/70 outline-none focus:border-primary/30 transition-colors"
              autoFocus
            />
          </div>
        </div>
              ...
              <div key={dateLabel}>
                ...
                {notes.map((note) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-7 h-7 rounded-md bg-foreground/[0.03] border border-foreground/6 flex items-center justify-center shrink-0">
                      ...
                      >
                        {isSelected && <Check size={10} className="text-primary-foreground" strokeWidth={2.5} />}
                      </div>
                    </button>
                  );
                })}
