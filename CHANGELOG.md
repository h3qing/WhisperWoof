...
### Tests
- 43 test files / 778 tests (up from 744 — net gain from real-source assertions in the refactored tests, including the webhooks SSRF / HMAC baseline assertions, focus-mode deterministic-time coverage, screen-vs-voice-command disambiguation guards, keybinding default-integrity checks, and rambling-signal /g-flag guards; zero regressions)
