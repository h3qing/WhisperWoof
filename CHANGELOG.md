...
### Tests
- 43 test files / 767 tests (up from 744 — net gain from real-source assertions in the refactored tests, including the new webhooks SSRF / HMAC baseline assertions, focus-mode deterministic-time coverage, and screen-vs-voice-command disambiguation guards; zero regressions)
