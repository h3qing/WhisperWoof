...
- **Settings export includes your Memory when encryption is on.** Export used to skip the encrypted Memory and style examples, and import wrote them back as plain files next to the encrypted ones. Both now go through encryption.
