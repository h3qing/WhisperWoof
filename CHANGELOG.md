...
- **Photos copied in Finder are kept as the photos.** Copying a photo file used to save only its name (and the Finder icon); now the photo itself is kept, up to 10 per copy, HEIC included.
...
- **You decide how much it keeps.** The Clipboard view says how many things are kept and how much space images take. Choose how long history is kept (forever, 90, 30 or 7 days) and how much space images may use (up to 2 GB, or no limit); past the limit the oldest images go first. The default keeps all text and caps images at 1 GB.
